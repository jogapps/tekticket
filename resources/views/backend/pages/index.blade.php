                                        ...
                                        <div class="card-box table-responsive">
                                            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                ...
                                                @forelse($pages as $page)
                                                    <tr>
                                                        <td>{{ $page->title }}</td>
                                                        <td>{{ $page->general ? 'Yes' : 'No' }}</td>
                                                        <td>{{ $page->top_question ? 'Yes' : 'No' }}</td>
                                                        <td>
                                                            <a href="{{ route('backend.pages.update', ['page' => $page]) }}" class="btn btn-sm btn-info">Details <i class="fa fa-arrow-right"></i></a>
                                                            <a href="{{ route('backend.pages.delete', ['page' => $page]) }}" class="btn pull-right btn-sm btn-danger">Delete <i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
